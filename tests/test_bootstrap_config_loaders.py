...
"""
    ...
    def test_inesdata_connector_service_account_roles_include_peer_connectors(self):
        keycloak_admin = mock.Mock()
        keycloak_admin.get_realm_roles.return_value = [
            {"name": "conn-org2-pionera", "attributes": {"connector": ["conn-org2-pionera"]}},
            {"name": "conn-org3-pionera", "attributes": {"connector": ["conn-org3-pionera"]}},
            {"name": "connector-user"},
