...
KUBERNETES_WORKLOAD_TOPOLOGY_KEYS = frozenset(
    {
        ...
        "VM_INGRESS_TLS_SECRET_NAME",
        "VM_INGRESS_TLS_CERT_FILE",
        "VM_INGRESS_TLS_KEY_FILE",
        "VM_INGRESS_TLS_CA_FILE",
        "VM_INGRESS_TLS_HOSTS",
        "VM_PUBLIC_INGRESS_TLS_HOSTS",
        "VM_INGRESS_TLS_AUTO_GENERATE_DEV_CERT",
        "VM_INGRESS_TLS_CERT_DAYS",
        "VM_INGRESS_TLS_DISABLE_SSL_REDIRECT",
        "VM_INGRESS_TLS_TRUSTSTORE_ENABLED",
        "VM_INGRESS_TLS_TRUSTSTORE_SECRET_NAME",
        "VM_INGRESS_TLS_TRUSTSTORE_PASSWORD",
        "VM_INGRESS_TLS_TRUSTSTORE_ALIAS",
        "CONNECTOR_TLS_CACERTS_SECRET_NAME",
    }
)
...
COMPONENT_SOURCE_TOPOLOGY_KEYS = frozenset(
    {
        "ONTOLOGY_HUB_SOURCE_REPOSITORY",
        "ONTOLOGY_HUB_REPOSITORY",
        "ONTOLOGY_HUB_SOURCE_REF",
        "ONTOLOGY_HUB_REPO_REF",
        "ONTOLOGY_HUB_SOURCE_REFRESH",
        "ONTOLOGY_HUB_REFRESH_SOURCE",
        "LEVEL5_ONTOLOGY_HUB_SOURCE_REFRESH",
        "AI_MODEL_HUB_SOURCE_REPOSITORY",
        "AI_MODEL_HUB_REPOSITORY",
        "AI_MODEL_HUB_DASHBOARD_SOURCE_REPOSITORY",
        "AI_MODEL_HUB_SOURCE_REF",
        "AI_MODEL_HUB_DASHBOARD_SOURCE_REF",
        "AI_MODEL_HUB_REPO_REF",
        "AI_MODEL_HUB_SOURCE_REFRESH",
        "AI_MODEL_HUB_REFRESH_SOURCE",
        "AI_MODEL_HUB_DASHBOARD_SOURCE_REFRESH",
        "LEVEL5_AI_MODEL_HUB_SOURCE_REFRESH",
    ...
    "vm-single": frozenset(
        {
            ...
            "COMPONENTS_RELEASE_SCOPE",
            "COMPONENTS_RELEASE_DATASPACE_NAME",
            "COMPONENTS_HELM_RELEASE_DATASPACE_NAME",
            "COMPONENTS_SHARED_RELEASE_COMPONENTS",
    ...
    "vm-distributed": frozenset(
        {
            ...
            "VM_DISTRIBUTED_POSTGRES_ACCESS_MODE",
            "VM_DISTRIBUTED_POSTGRES_DIRECT_PORT",
            "VM_DISTRIBUTED_POSTGRES_NODEPORT",
