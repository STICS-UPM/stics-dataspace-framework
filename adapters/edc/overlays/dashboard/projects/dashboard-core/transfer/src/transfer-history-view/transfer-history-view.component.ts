...
import { BehaviorSubject, from, map, Observable, of, shareReplay, Subject, takeUntil } from 'rxjs';
...
export class TransferHistoryViewComponent implements OnInit, OnDestroy {
  ...
  private async fetchHistory() {
    ...
    this.filteredTransferProcesses$ = transferProcesses$;
    this.setCurrentPageTransferProcesses([]);
  }
