...
public class InesdataTransferProcessApiController implements InesdataTransferProcessApi {
    ...
    public JsonObject initiateTransferProcess(JsonObject request) {
        ...
        DataAddress dataDestination = getDataDestinationProperties(transferRequest);
    ...
    private DataAddress getDataDestinationProperties(TransferRequest transferRequest) {
        Map<String, Object> properties = new HashMap<>();
        var requestedDestination = transferRequest.getDataDestination();
        if (requestedDestination != null && requestedDestination.getProperties() != null) {
            properties.putAll(requestedDestination.getProperties());
        }
