...
logos de proyecto/financiación en el pie, `Powered by:` como sección separada y
`LocalStore` como etiqueta visual de la opción funcional cuyo valor técnico
sigue siendo `InesDataStore`.
