...
PT5_CASES: List[Dict[str, str]] = [
    ...
    {
        "id": "PT5-OH-02",
        "description": "Modificar metadatos de una ontologia existente",
        "validation_type": "functional",
        "dataspace_dimension": "publication",
    },
    {
        "id": "PT5-OH-03",
        "description": "Eliminar una ontologia registrada",
        "validation_type": "functional",
        "dataspace_dimension": "publication",
    },
    {
    ...
    {
        "id": "PT5-OH-05",
        "description": "Crear usuarios y validar acceso segun rol",
        "validation_type": "functional",
        "dataspace_dimension": "access_control",
    },
    {
        "id": "PT5-OH-06",
        "description": "Ejecutar operaciones sobre ontologias",
        "validation_type": "non_functional",
        "dataspace_dimension": "governance",
    },
    {
        "id": "PT5-OH-07",
        "description": "Registrar una ontologia RDF/OWL",
        "validation_type": "interoperability",
        "dataspace_dimension": "interoperability",
    },
    {
        "id": "PT5-OH-08",
        "description": "Buscar ontologias por texto libre",
        "validation_type": "functional",
        "dataspace_dimension": "discovery",
    },
    {
        "id": "PT5-OH-09",
        "description": "Filtrar por metadatos y etiquetas",
        "validation_type": "functional",
        "dataspace_dimension": "discovery",
    },
    {
        "id": "PT5-OH-10",
        "description": "Consultar versiones especificas",
        "validation_type": "functional",
        "dataspace_dimension": "discovery",
    },
    {
        "id": "PT5-OH-11",
        "description": "Acceder a la ficha de una ontologia",
        "validation_type": "functional",
        "dataspace_dimension": "visualization",
    },
    {
        "id": "PT5-OH-12",
        "description": "Consultar estadisticas y popularidad",
        "validation_type": "functional",
        "dataspace_dimension": "visualization",
    },
    {
        "id": "PT5-OH-13",
        "description": "Ejecutar una consulta SPARQL",
        "validation_type": "interoperability",
        "dataspace_dimension": "interoperability",
    },
    {
        "id": "PT5-OH-14",
        "description": "Ejecutar servicios ontologicos checker/patrones",
        "validation_type": "integration",
        "dataspace_dimension": "services",
    },
    {
        "id": "PT5-OH-15",
        "description": "Acceder a funcionalidades via UI y API",
        "validation_type": "integration",
        "dataspace_dimension": "integration",
    },
    {
        "id": "PT5-OH-16",
        "description": "Validar conexion con el conector",
        "validation_type": "integration",
        "dataspace_dimension": "integration",
    },
]
